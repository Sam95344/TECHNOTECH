              ...
              <div className="card-content">
                <form onSubmit={verifyCertificate}>
                  <div style={{ marginBottom: "30px" }}>
                    ...
                    <input type="text" value={certInput} onChange={(e) => setCertInput(e.target.value)} style={{ width: "100%", background: "rgba(255, 255, 255, 0.04)", border: "2px solid rgba(255, 255, 255, 0.08)", padding: "20px 25px", borderRadius: "20px", color: "white", fontFamily: "'JetBrains Mono', monospace", fontSize: "1.1rem", transition: "all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275)", outline: "none" }} placeholder="CERT-XXXXXX" required />
                  </div>
